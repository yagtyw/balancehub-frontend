...
const OurCenter = () => {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      {/* === 5. Our Journey (Desktop/Mobile switch) === */}
      <section className={styles.journeySection}>
        <h2 className={styles.journeyName}>Our Journey</h2>
      ...
      <section className={styles.ctaSection}>
        ...
        <div className={styles.ctaButtons}>
          ...
          <Link href="/to-therapists" className={styles.ctaButton}>Join as a therapist</Link>
        </div>
      </section>
    </div>
  )
